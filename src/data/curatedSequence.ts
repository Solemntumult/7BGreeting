...
export const OFFICIAL_SEQUENCE: SlideData[] = [
  ...
  // 2. Devanture d'Honneur
  {
    id: 'seq-01-devanture',
    type: 'announcement',
    imageUrl: '/selection_photos_tv/01_facade_devanture_seven_b.jpg',
    title: 'Notre Cadre & Devanture d\'Honneur',
    description: 'Une entrée chaleureuse avec perron et service d\'accueil disponible 24h/24, 7j/7',
    duration: 4000,
    category: 'Accueil',
    active: true,
    order: 2
  ...
  // 3. Salons Contemporains
  {
    id: 'seq-02-salons',
    type: 'announcement',
    imageUrl: '/selection_photos_tv/salon_image005_hd.jpg',
  ...
  // 4. Espace Dîner
  {
    id: 'seq-03-diner',
    type: 'announcement',
    imageUrl: '/selection_photos_tv/espace_diner_image011.jpg',
  ...
  // 5. Chambres (Photo de lit avec rideaux jaunes et chemins de lit)
  {
    id: 'seq-04-chambres',
    type: 'announcement',
    imageUrl: '/selection_photos_tv/chambre_lit_prestige.jpg',
  ...
  // 7. Événements 1
  {
    ...
    type: 'announcement',
    imageUrl: '/selection_photos_tv/evenement_reception_01.jpg',
  ...
  // 8. Événements 2
  {
    ...
    type: 'announcement',
    imageUrl: '/selection_photos_tv/evenement_reception_02.jpg',
